...
export default function SliderTestimonial() {
    ...
    const slider = new Glide(".glide-08", {
      ...
      classes: {
        ...
        arrow: {
          ...
          hidden: "glide__arrow--hidden",
          // add your property here
          newProperty: "glide__arrow--newProperty",
        },
        nav: {
  ...
  return (
    <Section className="relative w-full glide-08">
      <Heading title="Testimonials" />
      {/*    <!-- Slides --> */}
      <div
        className="overflow-hidden text-center bg-white dark:bg-slate-600 rounded shadow-2xl dark:text-white  text-slate-500 shadow-slate-200 "
        data-glide-el="track"
      >
                ...
                <div className="relative p-6">
                  <figure className="relative z-10">
                    <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                      <p>
                        Wind-ui is probably one of the best libraries I ve come
                        across. Good looking, easy to use and above all super
                        accessible. If you haven t tried it yet just do so!
                      </p>
                    </blockquote>
              ...
              <div className="overflow-hidden">
                <div className="relative p-6">
                  <figure className="relative z-10">
                    <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                      <p>
                        Wind-ui components come with proper attributes to ensure
                        full accessibility with the WAI-ARIA standards. That s
                        just awesome for a free ui library.
                      </p>
                    </blockquote>
                    <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                      <span
